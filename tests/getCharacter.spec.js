...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    expect(getCharacter('arya')).toEqual(aryaInfos)
    expect(getCharacter('brienne')).toEqual(brienneInfos)
    expect(getCharacter('melissandre')).toEqual(melissandreInfos)
    expect(getCharacter('MELISSANDRE')).toEqual(melissandreInfos)
